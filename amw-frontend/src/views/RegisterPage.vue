          ...
          <div class="space-y-8">
            <div class="group">
              ...
              <input
                  ...
                  aria-describedby="register-message private-name-help"
              ...
              <p id="private-name-help" class="text-xs text-stone-500 mt-2">
                Solo se utilizará para tu cuenta. No se mostrará públicamente.
              </p>
            </div>

            <div class="group">
              <label class="block font-headline text-on-surface-variant text-sm mb-1" for="artistic-name">
                Nombre artístico
              </label>
              ...
              <input
                  ...
                  placeholder="Derek Visuals"
                  required
                  :aria-invalid="errorMessage ? 'true' : 'false'"
                  aria-describedby="register-message artistic-name-help"
                  class="w-full bg-transparent border-0 border-b border-outline-variant py-3 px-3 focus:ring-0 focus:border-primary transition-all duration-300 placeholder:text-zinc-400 placeholder:font-body"
              />

              <p id="artistic-name-help" class="text-xs text-stone-500 mt-2">
                Será el nombre visible en tu portfolio y publicaciones.
              </p>
            </div>

            <div class="group">
              <label class="block font-headline text-on-surface-variant text-sm mb-1" for="username">
                Apodo
              </label>
              ...
              <div class="relative">
                ...
                <input
                    ...
                    placeholder="derek.art"
                    minlength="3"
                    maxlength="30"
                    pattern="[A-Za-z0-9._]+"
                    required
                    :aria-invalid="errorMessage ? 'true' : 'false'"
                    aria-describedby="register-message username-help"
                    class="w-full bg-transparent border-0 border-b border-outline-variant py-3 pl-8 pr-3 focus:ring-0 focus:border-primary transition-all duration-300 placeholder:text-zinc-400 placeholder:font-body"
                />
              </div>

              <p id="username-help" class="text-xs text-stone-500 mt-2">
                Único en AMW. Solo puede contener letras, números, puntos y guiones bajos.
              </p>
            </div>
    ...
    async handleRegister() {
      ...
      try {
        await registerUser({
          ...
          specialty: this.discipline || null,
          email: this.email,
